...
//                holder.itemView.setBackgroundColor(Theme.getColor(Theme.key_avatar_backgroundActionBarBlue)); // telegraf Commented
                break;
            case 3:
...
//        items.add(null); // divider 11
        ...
        items.add(new Item(13, LocaleController.getString("imodares", R.string.mehdiChannel), R.drawable.menu_broadcast));

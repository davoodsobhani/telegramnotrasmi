...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate
{
    ...
    public View createView(Context context) {
        ...
        codeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        emojiTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

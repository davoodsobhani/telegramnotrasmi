...
public class ActionBar extends FrameLayout {
    ...
    private static ArrayList<View> listofall = new ArrayList<>(); // telegraf
    private ImageView ghostView; // telegraf
    ...
    public ActionBar(Context context) {
        super(context);
        listofall.add(this); // telegraf
        ThemeChanger.actionbar=this; // telegraf
        createGhostModeImage(); // telegraf
        changeGhostModeVisibility(); // telegraf
    }
    ...
    private void createSubtitleTextView() {
        ...
        subtitleTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

...
public class ChannelIntroActivity extends BaseFragment
{
    ...
    public View createView(Context context) {
        ...
        whatIsChannelText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        descriptionText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

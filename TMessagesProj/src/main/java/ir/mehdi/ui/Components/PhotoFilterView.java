...
import ir.mehdi.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        infoTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        paramTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        valueTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        blurOffButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        blurRadialButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        blurLinearButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

...
public class PasscodeView extends FrameLayout {
    ...
    public PasscodeView(final Context context) {
        ...
        passcodeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        if (Build.VERSION.SDK_INT >= 23 && parentActivity != null && UserConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    fingerprintTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
                    ...
                    fingerprintStatusTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

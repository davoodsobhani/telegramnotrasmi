...
import ir.mehdi.messenger.camera.CameraController;
import ir.mehdi.messenger.camera.CameraView;
...
import ir.mehdi.ui.Cells.PhotoAttachCameraCell;
import ir.mehdi.ui.Cells.PhotoAttachPhotoCell;
...
public class ChatAttachAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider, BottomSheet.BottomSheetDelegateInterface {
    ...
    public ChatAttachAlert(Context context, final ChatActivity parentFragment) {
        ...
        hintTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

...
import ir.mehdi.telegraf.AboutUsActivity;
import ir.mehdi.telegraf.FindUsersActivity;
import ir.mehdi.telegraf.LanguageActivity;
import ir.mehdi.telegraf.MySettingsActivity;
import ir.mehdi.telegraf.OnlineContactsActivity;
import ir.mehdi.telegraf.ReportActivity;
import ir.mehdi.telegraf.SelectColorActivity;
import ir.mehdi.telegraf.SelectFontActivity;
...
import ir.mehdi.messenger.NativeCrashManager;
...
import ir.mehdi.ui.ActionBar.DrawerLayoutContainer;
import ir.mehdi.ui.ActionBar.Theme;
import ir.mehdi.ui.Adapters.DrawerLayoutAdapter;
import ir.mehdi.ui.Components.EmbedBottomSheet;
import ir.mehdi.ui.Components.JoinGroupAlert;
import ir.mehdi.ui.Components.LayoutHelper;
import ir.mehdi.ui.Components.PasscodeView;
			...
			public void onItemClick(View view, int position)
			{
				...
				else if (id == 7)
				{
					try
					{
						...
						intent.putExtra(Intent.EXTRA_TEXT, ContactsController.getInstance().getInviteText()); // telegraf Invite
				...
				{
					MessagesController.openByUserName("imodares", actionBarLayout.fragmentsStack.get(0), 0);
					drawerLayoutContainer.closeDrawer(false);
				}
				else if (id == 14)
				{
		...
		else
		{
			...
			if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0)
			{
				if (intent != null && intent.getAction() != null && !restore)
				{
					...
					else if (intent.getAction().equals("ir.mehdi.messenger.OPEN_ACCOUNT"))
					{
						open_settings = 1;
					}

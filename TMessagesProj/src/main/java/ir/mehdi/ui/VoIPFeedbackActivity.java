...
import ir.mehdi.ui.Components.BetterRatingView;
...
public class VoIPFeedbackActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
		...
		commentBox.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

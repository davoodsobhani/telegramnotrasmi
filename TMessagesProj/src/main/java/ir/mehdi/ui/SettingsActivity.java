...
import ir.mehdi.ui.Cells.TextInfoCell;
import ir.mehdi.ui.Cells.EmptyCell;
import ir.mehdi.ui.Cells.HeaderCell;
import ir.mehdi.ui.Cells.ShadowSectionCell;
import ir.mehdi.ui.Cells.TextCheckCell;
import ir.mehdi.ui.Cells.TextDetailSettingsCell;
import ir.mehdi.ui.Cells.TextSettingsCell;
...
import ir.mehdi.ui.Components.NumberPicker;
...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private int themeRow = -1; // telegraf
...
//        themeRow = rowCount++; // telegraf Commented
    ...
    public View createView(Context context) {
        actionBar.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // telegraf
        actionBar.setItemsBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor(), false); // telegraf
        ...
        extraHeightView.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // telegraf
        ...
        onlineTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

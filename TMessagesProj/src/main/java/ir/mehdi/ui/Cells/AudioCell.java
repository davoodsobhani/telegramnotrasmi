...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        genreTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        authorTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

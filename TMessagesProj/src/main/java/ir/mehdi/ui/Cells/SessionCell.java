...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context) {
        ...
        detailTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
        ...
        detailExTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

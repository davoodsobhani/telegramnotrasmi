...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // telegraf
        ThemeChanger.addView(this); // telegraf
        ...
        phoneTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf

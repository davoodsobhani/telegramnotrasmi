...
import ir.mehdi.messenger.query.SharedMediaQuery;
...
import ir.mehdi.ui.Cells.AboutLinkCell;
import ir.mehdi.ui.Cells.DividerCell;
import ir.mehdi.ui.Cells.EmptyCell;
import ir.mehdi.ui.Cells.LoadingCell;
import ir.mehdi.ui.Cells.ShadowSectionCell;
import ir.mehdi.ui.Cells.TextCell;
import ir.mehdi.ui.Cells.TextDetailCell;
import ir.mehdi.ui.Cells.TextInfoPrivacyCell;
...
import ir.mehdi.ui.Components.AvatarUpdater;
...
//        actionBar.setItemsBackgroundColor(AvatarDrawable.getButtonColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id), false); // telegraf Commented
...
//        topView.setBackgroundColor(AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id)); // telegraf Commented
        ...
        for (int a = 0; a < 2; a++) {
            ...
            onlineTextView[a].setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf")); // telegraf
    ...
    public void setAnimationProgress(float progress) {
        ...
        int actionBarColor = ThemeChanger.getcurrent().getActionbarcolor(); // telegraf
        ...
        int aD;
//        topView.setBackgroundColor(Color.rgb(r + rD, g + gD, b + bD)); // telegraf Commented
        topView.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor()); // telegraf

...
package ir.mehdi.messenger.browser;
...
import ir.mehdi.messenger.ShareBroadcastReceiver;
import ir.mehdi.messenger.support.customtabs.CustomTabsCallback;
import ir.mehdi.messenger.support.customtabs.CustomTabsClient;
import ir.mehdi.messenger.support.customtabs.CustomTabsIntent;
import ir.mehdi.messenger.support.customtabs.CustomTabsServiceConnection;
import ir.mehdi.messenger.support.customtabs.CustomTabsSession;
import ir.mehdi.messenger.support.customtabsclient.shared.CustomTabsHelper;
import ir.mehdi.messenger.support.customtabsclient.shared.ServiceConnection;
import ir.mehdi.messenger.support.customtabsclient.shared.ServiceConnectionCallback;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri && !scheme.equals("tel")) {
                ...
                builder.setToolbarColor(ThemeChanger.getcurrent().getActionbarcolor()); // telegraf

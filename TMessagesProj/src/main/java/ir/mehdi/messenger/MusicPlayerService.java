...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "ir.mehdi.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "ir.mehdi.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "ir.mehdi.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "ir.mehdi.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "ir.mehdi.android.musicplayer.next";

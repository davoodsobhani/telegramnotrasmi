 ...
 */
package ir.mehdi.messenger.exoplayer2;
...
import ir.mehdi.messenger.exoplayer2.audio.AudioCapabilities;
import ir.mehdi.messenger.exoplayer2.audio.AudioRendererEventListener;
import ir.mehdi.messenger.exoplayer2.audio.AudioTrack;
import ir.mehdi.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import ir.mehdi.messenger.exoplayer2.decoder.DecoderCounters;
import ir.mehdi.messenger.exoplayer2.drm.DrmSessionManager;
import ir.mehdi.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import ir.mehdi.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import ir.mehdi.messenger.exoplayer2.metadata.Metadata;
import ir.mehdi.messenger.exoplayer2.metadata.MetadataRenderer;
import ir.mehdi.messenger.exoplayer2.metadata.id3.Id3Decoder;
import ir.mehdi.messenger.exoplayer2.source.MediaSource;
import ir.mehdi.messenger.exoplayer2.source.TrackGroupArray;
import ir.mehdi.messenger.exoplayer2.text.Cue;
import ir.mehdi.messenger.exoplayer2.text.TextRenderer;
import ir.mehdi.messenger.exoplayer2.trackselection.TrackSelectionArray;
import ir.mehdi.messenger.exoplayer2.trackselection.TrackSelector;
import ir.mehdi.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import ir.mehdi.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class SimpleExoPlayer implements ExoPlayer {
  ...
  protected void buildVideoRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.mehdi.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context, Handler mainHandler,
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.mehdi.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.mehdi.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);
    ...
    try {
      Class<?> clazz =
          Class.forName("ir.mehdi.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class);
      Renderer renderer = (Renderer) constructor.newInstance(mainHandler, componentListener);
      out.add(extensionRendererIndex++, renderer);

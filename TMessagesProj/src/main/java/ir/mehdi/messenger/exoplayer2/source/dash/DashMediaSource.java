...
import ir.mehdi.messenger.exoplayer2.ParserException;
import ir.mehdi.messenger.exoplayer2.Timeline;
import ir.mehdi.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
import ir.mehdi.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import ir.mehdi.messenger.exoplayer2.source.MediaPeriod;
...
import ir.mehdi.messenger.exoplayer2.source.dash.manifest.DashManifestParser;
import ir.mehdi.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import ir.mehdi.messenger.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            ir.mehdi.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      ir.mehdi.messenger.exoplayer2.source.dash.manifest.Period period =

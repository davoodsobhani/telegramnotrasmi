...
import ir.mehdi.messenger.exoplayer2.util.AtomicFile;
import ir.mehdi.messenger.exoplayer2.util.ReusableBufferedOutputStream;
...
/*package*/ final class CachedContentIndex {
   ...
   * ir.mehdi.messenger.exoplayer2.C#LENGTH_UNSET} otherwise.
   */

 ...
 */
package ir.mehdi.messenger.exoplayer2.text;

import ir.mehdi.messenger.exoplayer2.Format;
import ir.mehdi.messenger.exoplayer2.text.cea.Cea608Decoder;
import ir.mehdi.messenger.exoplayer2.text.subrip.SubripDecoder;
import ir.mehdi.messenger.exoplayer2.text.ttml.TtmlDecoder;
import ir.mehdi.messenger.exoplayer2.text.tx3g.Tx3gDecoder;
import ir.mehdi.messenger.exoplayer2.text.webvtt.Mp4WebvttDecoder;
import ir.mehdi.messenger.exoplayer2.text.webvtt.WebvttDecoder;
      ...
      try {
        switch (mimeType) {
          case MimeTypes.TEXT_VTT:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.webvtt.WebvttDecoder");
          case MimeTypes.APPLICATION_TTML:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.ttml.TtmlDecoder");
          case MimeTypes.APPLICATION_MP4VTT:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.webvtt.Mp4WebvttDecoder");
          case MimeTypes.APPLICATION_SUBRIP:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.subrip.SubripDecoder");
          case MimeTypes.APPLICATION_TX3G:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.tx3g.Tx3gDecoder");
          case MimeTypes.APPLICATION_CEA608:
            return Class.forName("ir.mehdi.messenger.exoplayer2.text.cea.Cea608Decoder");
          default:
            return null;
        }

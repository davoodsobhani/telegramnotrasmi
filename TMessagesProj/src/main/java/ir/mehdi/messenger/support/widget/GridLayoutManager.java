...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler recycler,
        ...
        final boolean layingOutInPrimaryDirection =
                itemDirection == ir.mehdi.messenger.support.widget.LayoutState.ITEM_DIRECTION_TAIL;
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        final boolean layingOutInPrimaryDirection =
                layoutState.mItemDirection == ir.mehdi.messenger.support.widget.LayoutState.ITEM_DIRECTION_TAIL;
        int count = 0;
        ...
        if (mOrientation == VERTICAL) {
            if (layoutState.mLayoutDirection == ir.mehdi.messenger.support.widget.LayoutState.LAYOUT_START) {
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
        ...
        final boolean ascend = (layoutDir == ir.mehdi.messenger.support.widget.LayoutState.LAYOUT_END) != mShouldReverseLayout;

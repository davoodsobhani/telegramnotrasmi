...
static const char *FileLoadOperationClassPathName = "ir/mehdi/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "ir/mehdi/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "ir/mehdi/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILir/mehdi/tgnet/RequestDelegateInternal;Lir/mehdi/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("ir/mehdi/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/mehdi/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("ir/mehdi/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("ir/mehdi/tgnet/ConnectionsManager"));
